...
def log_test_results(logger, writer, epoch, acc_groups, get_ys_func, tag, weighting=None):
    results = utils.get_results(acc_groups, get_ys_func, weighting=weighting)
